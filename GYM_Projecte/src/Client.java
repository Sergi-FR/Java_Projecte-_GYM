...
public class Client {
    ...
    private Client consultaClientBD(String dni) throws SQLException {
        ...
        String consulta = "SELECT C.DNI, Nom, Cognom, Data_naixement, Tel, Correu_e, Sexe, Condicio_Fisica, Comunicació_comercial, Data_Baixa FROM clients C, registres R where C.DNI=R.DNI and C.DNI = ?";
        ...
        if(rs.next()){
            ...
            LocalDate data_baixa= rs.getDate("Data_Baixa").toLocalDate();

            if(data_baixa != null){
                System.out.println("|________________________________________________________________");
                System.out.println("\tEl Client consultat esta donatde baixa\t\t");
    ...
    public void altaClient() throws SQLException {
        ...
        if (consultaClientBD(dniObj.getDni()) != null) {
            ...
            // Validació de Data
            // #######################################################################|
            System.out.println("Entra Data e naixement Ex:(DD-MM-YYYY)");
            ...
            System.out.println("Introdueix el Correu Elecronic del usuari");
            ...
            // Entrada Sexe
            // #######################################################################|
            System.out.println("Entra el Genere Del Client Ex:( M/F )");
            ...
            do {
                ...
                System.out.println("Entra el Telefono del nostre Client Ex( 736 26 71 84 )");
    ...
    private void modificarClientsBD(){
        ...
        try {
            ...
            System.out.println("Error al llançar la comanda de modificació a la base de dades");
